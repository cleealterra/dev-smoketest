...
describe('Add to cart', () => {
    ...
    it('C29967 mobile Per Itinerary Bundles', () => {
    ...
    it('C29968 mobile Per itinerary Optional Bundles with selection', () => {
    ...
    it('C29969 mobile - Per itinerary Optional Bundles with no selection', () => {
